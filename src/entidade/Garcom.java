...
public class Garcom extends Pessoa{
    ...
    public void atribuirMesa(int numeroMesa){
        if (!disponivel){
            throw new IllegalStateException("Garçom está atendendo" + mesaAtendida);
        }
    ...
    public void registrarPedido(Pedido pedido){
        if (mesaAtendida == null){
            throw new IllegalStateException("Garçom pronto para atender");
        }
        pedidosRegistrados.add(pedido);
        System.out.println("Pedido efetuado por" + nome);
    }
    public void notificar(String mensagem){
        System.out.println("Pedido concluído" + nome + ": " + mensagem);
    }
